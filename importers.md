...
The importer count for `github.com/psyb0t/procscope` could not be read from
[pkg.go.dev](https://pkg.go.dev/github.com/psyb0t/procscope?tab=importedby) on this run.
